...
namespace Moriarty.Msrc
{
    public class MS17_010 : IVulnerabilityCheck
    {
        ...
        public void Check(VulnerabilityCollection vulnerabilities, int buildNumber, List<int> installedKBs)
        {
            try
            {
                bool result = ScanForMs17_010(_targetIp);
                if (result)
                {
        ...
        static public bool ScanForMs17_010(string computer)
        {
            ...
            try
            {
                ...
                {
                    throw new InvalidOperationException("Invalid session setup response");
                }
                ...
                {
                    throw new InvalidOperationException("Invalid tree connect response");
                }
        ...
        private static byte[] ReadSmbResponse(NetworkStream stream)
        {
            ...
            int size = temp[3] + temp[2] * 0x100 + temp[1] * 0x10000;
